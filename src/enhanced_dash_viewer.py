...
class EnhancedDashOBDViewer:
    ...
    def __init__(self, csv_folder_path=None):
        ...
        # Group management
        self.groups = {"Default": []}  # Default group contains all PIDs initially
        self.pid_groups = {}  # Maps PID to group name
        ...
        for csv_file in csv_files:
            try:
                ...
                if all(col in df.columns for col in ['SECONDS', 'PID', 'VALUE', 'UNITS']):
                    ...
                    # Assign to Default group initially
                    self.groups["Default"].append(pid)
                    self.pid_groups[pid] = "Default"
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            # PID Selection and Groups
                            html.H5("PID Selection & Groups", className="mb-3"),
                            self.create_pid_and_group_controls(),
                            
                            html.Hr(),
                            
                            # Time Navigation
                            html.H5("Time Navigation", className="mb-3"),
                            self.create_enhanced_time_controls(),
    ...
    def create_pid_and_group_controls(self):
        """Create PID checkboxes and group management controls."""
        controls = []
        ...
        return html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    dbc.Button("+10s", id="btn-right-10", size="sm"),
                ], className="d-flex align-items-center mb-2"),
